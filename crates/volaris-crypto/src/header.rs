...
///
/// This does not need to be used outside of this corecrypto library
struct HeaderTag {
    pub version: [u8; 2],
    pub algorithm: [u8; 2],
    pub mode: [u8; 2],
...
impl Header {
    ...
    ///
    /// You may view more about what is used as AAD [here](https://brxken128.github.io/Volaris/volaris-crypto/Headers.html#authenticating-the-header-with-aad-v840).

...
/// This is an `enum` containing all AEADs supported by `volaris-crypto`
...
/// This is an array containing all AEADs supported by `volaris-crypto`.
///
...
///
/// ```rust
/// # use Volaris_corecrypto::primitives::*;

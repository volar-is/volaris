use corecrypto::key::vec_to_arr;
use corecrypto::primitives::Algorithm;
use corecrypto::primitives::ENCRYPTED_MASTER_KEY_LEN;
use corecrypto::primitives::MASTER_KEY_LEN;
use corecrypto::protected::Protected;
use corecrypto::Zeroize;
use corecrypto::{cipher::Ciphers, header::Keyslot};
...
// TODO(brxken128): make this available in the corecrypto

//! This provides functionality for restoring a dumped header that adheres to the volaris format, provided the target file contains enough empty bytes at the start to do so.

...
use corecrypto::cipher::Ciphers;
use corecrypto::header::{Header, HeaderType};
use corecrypto::key::decrypt_master_key;
use corecrypto::primitives::Mode;
use corecrypto::protected::Protected;
use corecrypto::stream::DecryptionStreams;
    ...
    W: Write + Seek,
{
    ...
    match header.header_type.mode {
        Mode::MemoryMode => {
            ...
            let payload = corecrypto::Payload {
                aad: &aad,
                msg: &encrypted_data,
            };

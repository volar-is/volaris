...
//!
//! This is known as "packing" within volaris.
//!
...
use corecrypto::header::{HashingAlgorithm, HeaderType};
use corecrypto::primitives::BLOCK_SIZE;
...
mod tests {
    ...
    use corecrypto::header::{HeaderType, HeaderVersion};

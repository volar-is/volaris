//! This module contains all cryptographic primitives used by `Volaris-core`
...
/// This is an `enum` containing all AEADs supported by `Volaris-core`
...
/// This is an array containing all AEADs supported by `Volaris-core`.
///
